...
class AchievmentListView: UIView {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(AchievmentItemView.self, forCellWithReuseIdentifier: String(describing: AchievmentItemView.self))
...
extension AchievmentListView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: String(describing: AchievmentItemView.self), for: indexPath)
        return cell
    }
}
